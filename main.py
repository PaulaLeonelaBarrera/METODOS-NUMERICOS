...
grapeWhite = io.ImageCollection('.\\Imagenes\\Train\\grapeWhite\\*.jpg')
grapeBlue = io.ImageCollection('.\\Imagenes\\Train\\grapeBlue\\*.jpg')
grapePink = io.ImageCollection('.\\Imagenes\\Train\\grapePink\\*.jpg')
